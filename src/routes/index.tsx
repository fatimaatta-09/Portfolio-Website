...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://fatimaatta-09.github.io/Portfolio-Website/" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "FR-OS — Fatima Rehman | Portfolio" },
      { name: "twitter:description", content: "Interactive OS-style portfolio: graphic design, cybersecurity, and AI research." },
    ],
  }),
  component: FROS,
});
